...
from core.utils import send_email, get_sha256, save_user_avatar
...
from core.blog_signals import oauth_user_login_signal
...
def emailconfirm(request, id, sign):
    ...
    site = get_current_site().domain
    content = '''
     <p>Congratulations, you have successfully bound your mailbox, you can use{type}Come and log in to this website directly without a password. You are welcome to continue to pay attention to this website, the address is</p>
...
def bindsuccess(request, oauthid):
    ...
    if type == 'email':
        ...
        title = 'Bind successfully'
        content = "Congratulations on your successful binding, you can use it in the future{type}Come and log in to this site directly without a password. Thank you for your interest in this site.".format(
            type=oauthuser.type)
