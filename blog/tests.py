...
from core.utils import get_current_site, get_sha256
...
class ArticleTest(TestCase):
    ...
    def test_validate_article(self):
        ...
        self.assertEqual(response.status_code, 200)
        from core.spider_notify import SpiderNotify
        ...
        self.__check_pagination__(p, 'Authors Article Archive', 'liangliangyy')

        p = Paginator(Article.objects.filter(category=category), 2)
        self.__check_pagination__(p, 'Category archive', category.slug)
        ...
        self.assertEqual(response.status_code, 200)
        from core.utils import block_code
    ...
    def test_image(self):
        ...
        with open(imagepath, 'rb') as file:
            ...
            self.assertEqual(rsp.status_code, 200)
        from core.utils import save_user_avatar, send_email
